...
if __name__ == "__main__":
    # Example usage for demo/testing purposes
    sample_user = {
        "user_id": "S7test",
        "name": "Siqi",
        #Mock avatar link: In the real project, a real URL should be generated by user upload.
        "avatar_url": "https://example.com/avatar_s7.png",
        #List of neighbor plant IDs: To be used in the plant sleep - talking community system in the future
        "neighbors": ["plant_001", "plant_002"],
        "plant_preference": {
            "likes_bright_light": True,
            "needs_frequent_water": False
        },
        #User dream record count: Used for statistics/achievement system
        "dream_log_count": 0
    }

    print("Adding a demo user...")
    user_id = add_user(sample_user)
    print(f"User inserted with _id: {user_id}")
